...
ChatBot for Website. NATIVE, No code, Conversational forms, Live Chat Bot, HelpDesk. Advanced and flexible ChatBot for WordPress.

== Description ==
= ChatBot for WordPress - WPBot =
WPBot is an easy to use, Native, No coding required, AI ChatBot plugin for your WordPress website. Own and Manage your ChatBot from the WordPress Dashboard.
...
This ChatBot for WordPress can work in <strong>Natural Language Processing Mode</strong> or <strong>Button Menu Driven</strong> Mode or a <strong>Combination of both</strong>. The ChatBot works with <strong>any language</strong>.

[Support, Bug Report, Feature Requests](https://www.quantumcloud.com/resources/free-support/) | [Live ChatBot Pro Version Demo](https://dev.quantumcloud.com/wpbot-pro-demo/) | <strong> Upgrade to [WPBOT Pro Now!](https://www.quantumcloud.com/products/chatbot-for-wordpress/)</strong> 
...
> ++ Free FaceBook messenger AddOn is available for WPBot Lite! Download [ChatBot for Messenger](https://wordpress.org/plugins/chatbot-for-messenger/). <strong>WhatsApp </strong>and OpenAI GPT-3 Integrations available as addons for WPBot Pro.

You can also integrate this ChatBot for WordPress with the <strong>Google's Dialogflow </strong> or OpenAI GPT-3 (Pro version addon) and give it AI and natural language processing powers and disable the built-in features. WPBot free version supports Dialogflow intents and text responses automatically once you integrate with your Dialogflow V2 agent.

> ChatBot for WordPress website - WPBot is fully compatible with DialogFlow V2. 
> <strong>OpenAI GPT-3</strong> is supported as an AddOn for WPBot Pro version. OpenAI’s API provides access to GPT-3, for a wide variety of natural language tasks
...
> [View Demo of the WPBOT WordPress ChatBot Pro Version](https://dev.quantumcloud.com/wpbot-pro-demo/)
...
= Does it support OpenAI GPT-3? =
OpenAI GPT3 is supported as an AddOn for the WPBot Pro version only.
...
3. Follow the steps in this tutorial correctly: https://dev.quantumcloud.com/wpbot-pro-demo/dialogflow-integration/
...
[This article](https://dev.quantumcloud.com/wpbot-pro-demo/dialogflow-integration/) can also be helpful in getting the required information from DialogFlow console.

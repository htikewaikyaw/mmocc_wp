...
define('QCLD_wpCHATBOT_VERSION', '4.1.3');
...
class qcld_wb_Chatbot
{
    ...
    public function qcld_wb_chatbot_init()
    {
        ...
        if (is_admin() && !empty($_GET["page"]) && ($_GET["page"] == "wpbot") || (!empty($_GET['page']) && $_GET['page']=='wpbot_help_page') || (!empty($_GET['page']) && $_GET['page']=='wpbot-panel') || ( !empty($_GET['page']) &&  $_GET["page"] == "wbcs-botsessions-page") ) {
    ...
    public function qcld_wb_chatbot_admin_scripts($hook)
    {
        ...
        if (((!empty($_GET["page"])) && ($_GET["page"] == "wpbot")) || ($hook == "widgets.php") || $_GET['page']=='wpbot_help_page' || $_GET['page']=='wpbot-panel' || $_GET["page"] == "wbcs-botsessions-page" ) {
...
<!--  <div class="container wppt-settings-section" style="margin-right:unset;margin-left:unset; margin-top:40px" id="general_help">
  ...
  <div class="container wppt-settings-section" style="margin-right:unset;margin-left:unset; display:block; margin-top:40px" id="general_int">
    <div class="content form-container qcbot_help_secion" style=""> 
      ...
      <h2 style="margin-top: 10px;color:#fff">WPBot Interactions</h2>
      <h3 style="color:#fff">You can create user interactions in the following ways:</h3>
      <div style="clear:both"></div>
      <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"> Predefined intents - Built-in ChatBot Features </a>
                </h4>
            </div>
            <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                <div class="panel-body"> Predefined intents can work without integration to DialogFlow API and AI. These are readily available as soon as you install the plugin and can be turned on or off individually. <div class="section-container">
            ...
            <div class="panel-heading" role="tab" id="headingTwo">
                <h4 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"> Menu Driven - Created with Conversational Form Builder Addon </a>
                </h4>
            </div>
            ...
            <div class="panel-heading" role="tab" id="headingThree">
                <h4 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree"> DialogFlow ES and CX </a>
                </h4>
            </div>
 ...
 <div class="" style="color:#fff">
 	  <h2 style="font-size:28px;margin-top: 10px;">Tips</h2>
      <h2 style="font-size:20px;margin-top: 10px;">Tutorial</h2>
    ...
    <div class="content form-container qcbot_help_secion" style="padding: 10px;color:#fff;">
      ...
      <p>To Debug: 1. Make sure that you have created the Google Project and the Service account as an Owner<br>
        ...
        3. Follow the steps in this tutorial correctly: <a href="https://dev.quantumcloud.com/wpbot-pro-demo/dialogflow-integration/" target="_blank">https://dev.quantumcloud.com/wpbot-pro-demo/dialogflow-integration/</a><br>
        ...
        7. Test the ChatBot in the browser Incognito mode</p>
    </div>
    <div class="content form-container qcbot_help_secion" style="padding: 10px;color:#fff;">
    ...
    <div class="content form-container qcbot_help_secion" style="padding: 10px;color:#fff;">
      ...
      <p>The most common reason for this is if the theme is coded incorrectly and jQuery is loaded from external source. jQuery is included with WordPress core and according to WordPress standard, jQuery must be included using wp_enqueue_script. <a href="https://developer.wordpress.org/reference/functions/wp_enqueue_script/" target="_blank">https://developer.wordpress.org/reference/functions/wp_enqueue_script/</a> . Please make sure if that is the case in your theme.<br>
        ...
        Please contact us if you need [further help](<a href="https://www.quantumcloud.com/resources/free-support/" target="_blank">https://www.quantumcloud.com/resources/free-support/</a>). We take all user feedback sriously. </p>
    </div>
    <div class="content form-container qcbot_help_secion" style="padding: 10px;color:#fff;">

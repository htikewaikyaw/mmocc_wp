...
<!-- show featured  by HWK  -->
<h4><?php $text = ' Featured Posts '; esc_html_e( $text ); ?></h4>
<p><input class="checkbox" type="checkbox" <?php checked( $bools[ 'show_featured' ] ); ?> id="" name="<?php echo $this->get_field_name( 'show_featured' ); ?>" />
<label for="<?php echo $field_ids[ 'show_featured' ]; ?>"><?php esc_html_e( 'Show featured?', 'recent-posts-widget-with-thumbnails' ); ?></label></p>

...
if (!class_exists('\Tablesome\Components\Table\Settings\Config\Customize\Fields\Filter')) {
    class Filter
    {
        ...
        {
            $selectors = [
                "filter" => ".tablesome-header__wrapper .tablesome-filter .tablesome-filter__button",
                "filter_hover" => ".tablesome-header__wrapper .tablesome-filter .tablesome-filter__button:hover",
            ];

    ...
    class Settings
    {
        ...
        public function init_settings()
        {
            ...
            if (class_exists('\CSF')) {
                ...
                $options = array(
                    'menu_title' => __('Tablesome Settings', "tablesome"),
        ...
        public function notion_settings($prefix)
        {
            $fields = array(
                ...
                array(
                    'type' => 'submessage',
                    'style' => 'info',
                    'content' => '<p>Step 1: Generate Notion API Key <a href="https://developers.notion.com/docs/getting-started#getting-started" target="_blank">Here >></a>.</p><p>Step 2: Share your database with your Notion integration <a href="https://developers.notion.com/docs/getting-started#step-2-share-a-database-with-your-integration" target="_blank">Here >></a>.</p>',
                ),
            );

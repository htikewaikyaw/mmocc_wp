...
Tags: localization, translate, translation, language, translator, translatepress, loco, multilingual, multilanguage
...
> Install this plugin along with **[TranslatePress](https://wordpress.org/plugins/translatepress-multilingual/#description)** plugin and make your life easier.

* Free version supports Yandex translate widget.
* **[Pro version 💎](https://coolplugins.net/product/automatic-translate-addon-for-translatepress-pro/?utm_source=plugin_wppage&utm_medium=link)** supports Google translate widget along with Yandex and provides unlimited translations without any API key.
...
https://www.youtube.com/watch?v=GJdz_Z47ayw
...
* We also provide **[pro version 💎](https://coolplugins.net/product/automatic-translate-addon-for-translatepress-pro/?utm_source=plugin_wppage&utm_medium=link)** that supports **Google Page Translate Widget**. You can also use it for unlimited translations without any API key.
...
Special thanks to famous **[TranslatePress – Translate Multilingual sites](https://wordpress.org/plugins/translatepress-multilingual/)** plugin author **cozmoslabs,Razvan Mocanu** for creating an awesome plugin for translations and also thanks to Yandex for providing a translate widget for websites.
...
== Screenshots ==
1. Preview
2. Follow these steps and choose language
3. All strings in popup preview
4. Choose Language and translate all strings

== Installation ==

1. Install **Translate Press Addon** from the WordPress.org repository or by uploading plugin-zip unzipped folder to the **/wp-content/plugins** directory. You must also install **[TranslatePress – Translate Multilingual sites](https://wordpress.org/plugins/translatepress-multilingual/)** free plugin if you want to use this addon.
...
4. If you want to use Google Translate Widget for automatic translation then you need to purchase [premium plugin](https://coolplugins.net/product/automatic-translate-addon-for-translatepress-pro/?utm_source=plugin_wppage&utm_medium=link).
